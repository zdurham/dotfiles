...
return function(app_name)
	...
	if app_name:match("^Adobe Bridge") then
		return ":adobe_bridge:"
	end
	if app_name:match("^Adobe Illustrator") then
		return ":illustrator:"
	end
	if app_name:match("^Adobe InDesign") then
		return ":indesign:"
	end
	if app_name:match("^Adobe Photoshop") then
		return ":photoshop:"
	end
	if app_name:match("^MongoDB Compass") then
		return ":mongodb:"
	end
